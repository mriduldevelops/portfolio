...
function Contact() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .send(
                'service_fx8oc4c', // Replace with your EmailJS service ID
                'template_z7vxzqf', // Replace with your EmailJS template ID
                formData, // Pass the form data
                'BRciqBM6r4W2W4dNJ' // Replace with your EmailJS user ID
            )
            .then(
                (result) => {
